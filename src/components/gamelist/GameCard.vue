  ...
  <div class="flex flex-col items-center w-250 h-170 xl:w-350 pr-8 pb-4">
    ...
    <div class="flex w-full justify-between">
      <div class="flex items-center">
        ...
        <img
          v-for="(item, index) in getGenreType(game.genre)"
          :key="index"
          class="w-3 mt-1 mr-1 xl:w-4 object-scale-down xl:mt-2 xl:mr-2"
  ...
  methods: {
    getGenreType: genre => {
      ...
      for (let item of genre) {
        if (!categories.find(category => category == item.type))
